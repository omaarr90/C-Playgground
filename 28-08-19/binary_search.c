...
size_t recursive_binarySearch(const int b[], int searchKey, size_t low, size_t high);
...
int main(void)
{
   ...
   size_t result = recursive_binarySearch(a, key, 0, SIZE - 1);
...
size_t recursive_binarySearch(const int b[], int searchKey, size_t low, size_t high)
{
   // loop until low index is greater than high index
    ...
    if (searchKey == b[middle]) {                       
        ...
        return recursive_binarySearch(b, searchKey, low, middle - 1);                   
    }                                     
      // if searchKey is greater than middle element, set new low
    else {          
        return recursive_binarySearch(b, searchKey, middle + 1, high);                                                              
    }                                                                             
} 
